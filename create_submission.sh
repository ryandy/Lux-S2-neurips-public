...
docker exec -w /root $container_name bash ./compile.sh -b docker_build -d
...
tar --exclude=./$submisson_archive -czvf "$submisson_archive" . && echo "successfully built submission"
